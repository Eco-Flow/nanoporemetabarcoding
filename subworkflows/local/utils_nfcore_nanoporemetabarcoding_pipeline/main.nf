//
// Subworkflow with functionality specific to the nf-core/nanoporemetabarcoding pipeline
//
...
\033[0;35m  nf-core/nanoporemetabarcoding ${workflow.manifest.version}\033[0m
-\033[2m----------------------------------------------------\033[0m-
"""
...
* Software dependencies
    https://github.com/nf-core/nanoporemetabarcoding/blob/main/CITATIONS.md
"""
    if (monochrome_logs) {
    ...
    def valid_metadata = metadata
                       ...
                       .map { fastq, primer_comb, sample ->
                                    ...
                                    if (!duplicates_primer_comb.isEmpty()) {
                                        error("<tag-primer_comb> column in metadata contains repeated values for ${fastq}: ${duplicates_primer_comb.join(', ')}")
